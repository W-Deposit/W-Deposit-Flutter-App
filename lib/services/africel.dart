...
class Africel extends StatefulWidget {


  @override
  _AfricelState createState() => _AfricelState();
}

class _AfricelState extends State<Africel> {
  void initState() {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Container(
              child: Image.asset('assets/africel.png'),
            ),
            Container(
              child:Text('Envoyez de l’argent avec Africel Money .',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
            ),
            SizedBox(height: 20,),
            Container(
